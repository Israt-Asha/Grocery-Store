...
namespace Grocery_Store
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=F:\C#\Grocery Store\Grocery Store\Database1.mdf; Integrated Security=True");
